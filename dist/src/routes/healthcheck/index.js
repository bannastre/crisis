...
exports.healthcheckRouter.get('/ping', (_, res) => res.status(200).send({ message: 'ok' }));
exports.healthcheckRouter.get('/ready', (_, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
